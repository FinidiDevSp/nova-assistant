...
Incluye **TTS** con `pyttsx3` y plugins de **saludo**, **volumen**, **control del sistema** (apagar o hibernar el ordenador), **pantalla** (apagarla o ajustar el brillo), **navegador** (abre un navegador web), **clima**, consulta de **hora**, gestión de **notas** y un plugin de **alarmas/temporizadores** además del plugin de **modos** configurable.
